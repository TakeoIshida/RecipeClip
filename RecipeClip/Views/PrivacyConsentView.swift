            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    consentRow(
                        icon: "iphone",
                        title: "レシピは端末内に保存",
                        description: "料理名、材料、手順、メモ、買い物リストは運営者のサーバーへ送信しません。"
                    )
                    consentRow(
                        icon: "network",
                        title: "動画情報はYouTubeから取得",
                        description: "動画IDを送信してタイトル、チャンネル、サムネイルを取得します。GoogleがIPアドレスなどを取り扱う場合があります。"
                    )
                    consentRow(
                        icon: "wand.and.stars",
                        title: "説明欄の解析は端末内",
                        description: "ユーザーが貼り付けた説明欄のみを解析し、説明欄そのものは保存しません。"
                    )
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text("「同意してはじめる」を押すと、上記の内容とYouTube利用規約に同意したものとみなされます。")
                            .font(.footnote)
